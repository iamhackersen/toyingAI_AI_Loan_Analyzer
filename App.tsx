        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900 tracking-tight">Loan AI Analyzer</h1>
                <p className="text-xs text-slate-500 hidden sm:block">Full Spectrum Credit Analyzer</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-green-50 text-green-700 rounded-full text-sm font-medium border border-green-100">
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] animate-in fade-in zoom-in duration-500">
              <div className="text-center max-w-4xl mx-auto mb-12">
                <h2 className="text-4xl font-extrabold text-slate-900 mb-6 tracking-tight">
                  Will the bank approve this loan?
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left max-w-3xl mx-auto">
                   <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                      <div className="text-blue-600 font-bold mb-2">1. Cash Flow</div>
                      <p className="text-sm text-slate-600">Can they make monthly payments? (DSCR ≥ 1.25x)</p>
                   </div>
                   <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                      <div className="text-blue-600 font-bold mb-2">2. Leverage</div>
                      <p className="text-sm text-slate-600">Is the debt load too high? (Debt/EBITDA &lt; 3.0x)</p>
                   </div>
                   <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                      <div className="text-blue-600 font-bold mb-2">3. Liquidity</div>
                      <p className="text-sm text-slate-600">Can they survive short-term? (Current Ratio ≥ 1.2x)</p>
                   </div>
                   <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                      <div className="text-blue-600 font-bold mb-2">4. Solvency</div>
                      <p className="text-sm text-slate-600">Do owners have skin in the game? (Debt/Equity ≤ 2.5x)</p>
                   </div>
                </div>
              </div>
          ...
          {state.status === 'error' && (
            <div className="flex flex-col items-center justify-center min-h-[50vh] animate-in fade-in">
              <div className="bg-red-50 p-8 rounded-2xl border border-red-100 max-w-md text-center">
                ...
                <button 
                  onClick={handleReset}
                  className="w-full inline-flex justify-center rounded-lg bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:w-auto"
                >
                  Try Again
                </button>
              </div>
